...
INSERT INTO users (username, password, enabled) SELECT 'admin', '$2a$10$ymaklWBnpBKlgdMgkjWVF.GMGyvH8aDuTK.glFOaKw712LHtRRymS', TRUE WHERE NOT EXISTS (SELECT * FROM users WHERE username='admin');
